...
<html lang="en">
<head>
	<title>Administrator IONs INTERNATIONAL EDUCATION</title>
	<meta charset="utf-8">
...
<header id="top">
	<div class="container_12 clearfix">
		<div id="logo" class="grid_12">
			...
			<a id="site-title">E-Learning <span>IONs International Education | TRUE MANDARIN</span></a>
		...
		<form method="POST"action="cek_login.php" onSubmit="return validasi(this)">
			...
			<p>
				<input type="submit" class="button white" value="Login"></input>
                                ...
                                <tr>
                                <td height="30"><a href="registrasiadmin.php" class="txt"><b>Daftar Pengajar</b></a><br>
														</td>
													</tr>
			</p>
		</form>
